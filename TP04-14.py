...
Por ejemplo usuario@dominio.com.ar.

Para que una dirección sea considerada válida el nombre de usuario debe poseer solamente caracteres alfanuméricos,
...
def verificarMail(mail):
    if ".com.ar." not in mail:
        
        
    
mail = "usuario@dominio.com.ar."
